      ...
      <div class="panel panel-default" >
        ...
        <div class="panel-body">
          <form method="post" action="categorie.php">
            ...
            <button type="submit" name="add_cat" style="background-color:#d4c8e8">Add Category</button>
        </form>
        </div>
      </div><br><br><br>
    </div>
      ...
      <div class="panel-heading">
        ...
        <div class="panel-body">
          <table class="table table-bordered table-striped table-hover">
            <thead>
                <tr>
                    <th class="text-center" style="width: 50px; color:#18340e">#</th>
                    <th style="color:#18340e">Categories</th>
                    <th class="text-center" style="width: 100px; color:#18340e">Actions</th>
                </tr>
            </thead>
            <tbody>
