...
<div class="login-page">
    <div class="text-center">
       <h3 style= "color:#324a47">Add new user Group</h3>
     </div><br><br>
     <?php echo display_msg($msg); ?>
      <form method="post" action="add_group.php" class="clearfix">
        <div class="form-group">
              <label for="name" class="control-label"style= "color:#324a47"><b>Group Name</b></label>
              <input type="name" class="form-control" name="group-name">
        </div>
        <div class="form-group">
              <label for="level" class="control-label"style= "color:#324a47"><b>Group Level</b></label>
              <input type="number" class="form-control" name="group-level">
        </div>
        <div class="form-group">
          <label for="status"style= "color:#324a47"><b>Status</b></label>
        ...
        <div class="form-group clearfix">
                <button type="submit" name="add" style=" background-color:#8b708c" ><b>Update</b></button>
        </div>
    </form>
</div>
