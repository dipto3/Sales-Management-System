    ...
    <div class="panel-heading clearfix">
     ...
     <div class="panel-body">
      <table class="table table-bordered">
        <thead>
          <tr>
            <th class="text-center text-success" style="width: 50px;">#</th>
            <th class="text-success">Group Name</th>
            <th class="text-center text-success"style="width: 20%;">Group Level</th>
            <th class="text-center text-success" style="width: 15%;">Status</th>
            <th class="text-center text-success" style="width: 100px;">Actions</th>
          </tr>
        </thead>
        <tbody>
        <?php foreach($all_groups as $a_group): ?>
          <tr>
           ...
           <?php if($a_group['group_status'] === '1'): ?>
            <span class="label label-info"><?php echo "Active"; ?></span>
          <?php else: ?>
