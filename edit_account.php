...
<div class="row">
  ...
  <div class="col-md-8" style="padding-left: 450px;">
            ...
            <div class="col-md-8">
              ...
              <div class="form-group">
                <input type="hidden" name="user_id" value="<?php echo $user['id'];?>">
                 <button type="submit" name="submit" class="btn btn-success" id="hover">Change</button>
              </div>
             </form>
            </div>
          </div>
      ...
      <div class="panel-body">
          <form method="post" action="edit_account.php?id=<?php echo (int)$user['id'];?>" class="clearfix">
            ...
            <div class="form-group clearfix">
                    <a href="change_password.php" title="change password" class="btn btn-info pull-right" id="change">Change Password</a>
                    <button type="submit" name="update" class="btn btn-success" id="hover">Update</button>
            </div>
        </form>
      </div>
    </div>
